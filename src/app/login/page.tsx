        ...
        <Card className="shadow-2xl border-none overflow-hidden">
          <Tabs defaultValue="login" className="w-full" onValueChange={(v) => {
            ...
            <TabsList className="grid w-full grid-cols-2 rounded-none h-14 bg-muted/50">
              <TabsTrigger value="login" className="data-[state=active]:bg-white data-[state=active]:shadow-none font-bold">Sign In</TabsTrigger>
              <TabsTrigger value="signup" className="data-[state=active]:bg-white data-[state=active]:shadow-none font-bold">Create Account</TabsTrigger>
            </TabsList>
            ...
            <CardContent className="pt-8 px-8 pb-10 space-y-6">
              ...
              <Button 
                ...
                variant="outline"
                className="w-full h-12 text-sm font-bold gap-3 border-2 hover:bg-muted/50 transition-all" 
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-white px-3 text-muted-foreground font-bold">Or continue with email</span>
                </div>
              </div>
              ...
              <form onSubmit={handleEmailAuth} className="space-y-4">
                ...
                <Button type="submit" className="w-full h-12 font-bold shadow-lg shadow-primary/20" disabled={isLoggingIn}>
                  {isLoggingIn ? (
